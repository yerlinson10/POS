            ...
            <div
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-4">
                    ...
                    <div class="md:w-1/3 flex items-center">
                        <Button as="a" href="/categories/create" class="md:w-auto">New</Button>
                    </div>
                ...
                <Table>
                    <TableCaption>{{ categories.total ? 'List of Categories.' : 'There are no categories available' }}
                    </TableCaption>
                    <TableHeader>
                        <TableRow>
                    ...
                    <TableBody>
                        <TableRow v-for="p in categories.data" :key="p.id" class="text-center">
                ...
                <Pagination v-slot="{ page: internalPage }" :items-per-page="filters.per_page"
                    ...
                    <PaginationContent v-slot="{ items: pages }">
                        ...
                        <PaginationEllipsis :index="4" v-if="categories.last_page >= 4" />
