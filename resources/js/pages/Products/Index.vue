            ...
            <div
                ...
                <div class="flex flex-col gap-2 md:gap-4 p-2 md:p-6 border-b bg-muted/30">
                    <div class="flex flex-col xs:flex-row xs:items-center justify-between gap-2 xs:gap-0">
                        <div>
                            <h2 class="text-base md:text-xl font-semibold">Products Management</h2>
                            <p class="text-xs md:text-sm text-muted-foreground hidden xs:block">
                                Manage your product catalog and inventory
                            </p>
                        </div>
                        <div class="flex items-center gap-2">
                            <Button as="a" href="/products/create" size="sm" class="h-8 md:h-11 px-2 md:px-6 text-xs md:text-sm">
                        ...
                        <div class="flex gap-2">
                            <Select v-model="filters.sort_by" @update:modelValue="search">
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="unitMeasure.code">Unit</SelectItem>
                                </SelectContent>
                            </Select>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                <tr v-for="p in products.data" :key="p.id"
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex flex-col gap-1">
                                            ...
                                            <div class="flex items-center gap-2 text-xs text-muted-foreground">
                                                <span class="font-mono bg-muted px-1.5 py-0.5 rounded">{{ p.sku }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <!-- Unit -->
                                    <td class="px-4 py-4">
                                        <span class="text-sm text-muted-foreground">{{ p.unit_measure }}</span>
                                    </td>
                                    ...
                                    <td class="px-4 py-4 text-center">
                                        <span
                                            ...
                                            :class="{
                                                'bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400': p.stock > 10,
                                                'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/20 dark:text-yellow-400': p.stock <= 10 && p.stock > 0,
                                                'bg-red-100 text-red-800 dark:bg-red-900/20 dark:text-red-400': p.stock === 0
                                            }">
                ...
                <!-- Compact Pagination -->
                <div v-if="products.data.length > 0" class="flex flex-col xs:flex-row xs:items-center justify-between gap-2 xs:gap-4 p-2 md:p-4 border-t bg-muted/20">
